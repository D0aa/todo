    ...
    return Scaffold(
      ...
      body: BlocConsumer<TasksCubit, TasksState>(
        ...
        builder: (context, state) {
          ...
          return State is GetAllTasksLoadingState?CircularProgressIndicator.adaptive() :
          Visibility(
            ...
            replacement: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  Lottie.network('https://lottie.host/5d5fd84b-cb7f-4eda-9044-16582e6a1b34/mS260alA1q.json',repeat: false,height: 200.h,
                      errorBuilder:(context, error, stackTrace) => Icon(Icons.error_outline), ),
                  TextCustom(text: 'No Tasks yet, Please add some tasks',fontSize: 25,fontWeight: FontWeight.bold,),
                ],
              ),
            ),
